...
try:
    from ..ava.tools import WebSearchTool, WebBrowseTool, FactVerificationTool
except ImportError:
    WebSearchTool = None
    WebBrowseTool = None
...
try:
    from ..hippocampus.titans import EpisodicMemoryStore, EpisodicMemory
except ImportError:
...
class AVACoreSystem:
    ...
    def __init__(
        ...
        self._episodic_store: Optional[Any] = None  # EpisodicMemoryStore
