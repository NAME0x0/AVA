...
class InteractionRecord:
    ...
    # Context used
    neural_context: Optional[str] = None
...
class ConsciousStream:
    ...
    async def _retrieve_neural_context(
        ...
        try:
            ...
            memory_output = self.neural_memory.retrieve(embedding)
    ...
    async def _retrieve_semantic_context(self, query: str) -> Optional[str]:
        """
    ...
    def _construct_prompt(
        ...
        neural_context: Optional[str],
        semantic_context: Optional[str],
        episodic_context: Optional[List[str]],
