...
class EnhancedWebSearch:
    ...
    def __init__(
        ...
        logger.info(f"Enhanced Web Search initialized with {primary_engine.value} as primary engine")
    ...
    def _is_safe_content(self, result: SearchResult, safety_level: SafetyLevel) -> bool:
        ...
        unsafe_keywords = ['adult', 'explicit', 'nsfw'] if safety_level == SafetyLevel.STRICT else []
