...
class CalculationResult:
    ...
    success: bool
    result: Union[float, int, complex, str] = None
...
class SafeExpressionParser:
    ...
    def parse_and_evaluate(self, expression: str) -> Union[float, int, complex]:
        """
    ...
    def _evaluate_ast(self, node: ast.AST) -> Union[float, int, complex]:
