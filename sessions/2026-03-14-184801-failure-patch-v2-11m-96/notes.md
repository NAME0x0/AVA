# Training Session: failure-patch-v2-11m-96

## Command

`ava session train failure-patch-v2-11m-96 configs/experiments/ava-11m-failure-patch-v2.yaml corpora/failure_patch_v1 --max-steps 96`

## Inputs

- Config: `configs/experiments/ava-11m-failure-patch-v2.yaml`
...
- Optimizer steps: `48`
- Final loss: `0.0066`
- Minimum logged loss: `0.0066`
- Train eval loss: `0.0164`
- Validation loss: `0.3383`
- Runtime seconds: `16.671`
- Tokens seen: `196608`
- Supervised examples kept: `27/27`
- Truncated supervised examples: `0`
- Max prompt+response tokens: `150`
- Checkpoint: `sessions\2026-03-14-184801-failure-patch-v2-11m-96\checkpoints\ava-11m-failure-patch-v2.pt`
- Checkpoint sha256: `39a3afa5a99d688aabce7b30f5d33587913faed853144955d38a7f36720fa415`
...
- [benchmark:science] prompt=`What planet is known as the Red Planet?` expected=`Mars` matched=`False` completion=`[car 493`
...
- step=2, loss=0.1097, lr=1.25e-06
- step=4, loss=0.1155, lr=2.5e-06
- step=6, loss=0.1077, lr=3.75e-06
- step=8, loss=0.0858, lr=5e-06
- step=10, loss=0.0952, lr=5e-06
- step=12, loss=0.0956, lr=5e-06
- step=14, loss=0.0475, lr=5e-06
- step=16, loss=0.072, lr=5e-06
