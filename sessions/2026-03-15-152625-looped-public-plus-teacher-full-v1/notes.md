# Training Session: looped-public-plus-teacher-full-v1

## Command

`ava session train looped-public-plus-teacher-full-v1 configs/experiments/ava-11m-looped-public-plus-teacher-full-v1.yaml corpora/public_benchmark_plus_teacher_v1 --max-steps 64`

## Inputs

- Config: `configs/experiments/ava-11m-looped-public-plus-teacher-full-v1.yaml`
...
- Optimizer steps: `32`
- Final loss: `8.2586`
- Minimum logged loss: `3.7781`
- Train eval loss: `7.2797`
- Validation loss: `7.5004`
- Runtime seconds: `4.985`
- Tokens seen: `65536`
- Supervised examples kept: `5082/12532`
- Truncated supervised examples: `7546`
- Max prompt+response tokens: `1048`
- Checkpoint: `sessions\2026-03-15-152625-looped-public-plus-teacher-full-v1\checkpoints\ava-11m-looped-public-plus-teacher-full-v1.pt`
- Checkpoint sha256: `3dc3718dbd8a1fa7da8be30827458000ec4c0610add0204a2883570e04303af8`
...
- [benchmark:english] prompt=`Rewrite this sentence in plain English: The plan ain't done.` expected=`The plan is not finished yet.` matched=`False` completion=`p 4 pp p iiiiii ........`
- [benchmark:english] prompt=`Summarize this sentence in fewer words: The cat slept on the warm window sill.` expected=`The cat slept on the warm sill.` matched=`False` completion=`iiiiiiiiiiiii ii iiiiiiiiii ......`
- [benchmark:math] prompt=`What is 17 * 29?` expected=`493` matched=`False` completion=`4999`
...
- [tool:trace] prompt=`Use the calculator tool for sqrt(81). Return a compact calculator trace followed by the final answer.` matched=`False` failed_checks=`missing_required_all` completion=`ap .`
- [tool:trace] prompt=`Use the calculator tool for 25 + 17. Return a compact calculator trace followed by the final answer.` matched=`False` failed_checks=`missing_required_all` completion=`[capp 4 4 4=>999993`
...
- step=2, loss=9.5891, lr=5e-07
- step=4, loss=9.1449, lr=1e-06
- step=6, loss=10.6462, lr=1.5e-06
- step=8, loss=4.0594, lr=2e-06
- step=10, loss=6.7852, lr=2e-06
- step=12, loss=15.7996, lr=2e-06
- step=14, loss=11.1944, lr=2e-06
- step=16, loss=13.8912, lr=2e-06
