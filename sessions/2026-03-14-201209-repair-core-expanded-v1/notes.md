# Memory Transfer Session: repair-core-expanded-v1

## Command

`ava session memory-transfer repair-core-expanded-v1 sessions/2026-03-14-184859-failure-patch-v2-rerun-11m-96/checkpoints/ava-11m-failure-patch-v2.pt corpora/tool_repair_core_v1 --device cuda --max-new-tokens 48 --nearest-threshold 0.45 --nearest-margin 0.0 --suite expanded`

## Inputs

- Checkpoint: `sessions/2026-03-14-184859-failure-patch-v2-rerun-11m-96/checkpoints/ava-11m-failure-patch-v2.pt`
- Support corpus: `corpora/tool_repair_core_v1`
- Support files: `3`
- Support examples: `42`
...
- Exact direct: benchmark `8/20`, tool `8/12`, compliance `8/8`
- Nearest direct: benchmark `19/20`, tool `12/12`, compliance `8/8`
- Winner: `nearest`
