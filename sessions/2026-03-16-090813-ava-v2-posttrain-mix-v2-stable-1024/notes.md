# Training Session: ava-v2-posttrain-mix-v2-stable-1024

## Command

`ava session train ava-v2-posttrain-mix-v2-stable-1024 configs/experiments/ava-v2-recurrent-depth-posttrain-mix-v2-stable.yaml corpora/ava_v2_posttrain_mix_v1 --max-steps 1024`
...
- Optimizer steps: `128`
- Final loss: `1.821`
- Minimum logged loss: `0.3813`
- Train eval loss: `1.5204`
- Validation loss: `1.6863`
- Runtime seconds: `69.576`
- Tokens seen: `786432`
- Supervised examples kept: `11239/12416`
- Truncated supervised examples: `1201`
- Max prompt+response tokens: `925`
- Checkpoint: `sessions\2026-03-16-090813-ava-v2-posttrain-mix-v2-stable-1024\checkpoints\ava-v2-recurrent-depth-posttrain-mix-v2-stable.pt`
- Checkpoint sha256: `7f5ced871abf1acb5436a1a75d2686970e0011bb38fa88ea2ad618026ebd1a1d`
...
- [benchmark:math] prompt=`Solve for x: 2x + 6 = 14.` expected=`4` matched=`False` completion=`C`
...
- [tool:trace] prompt=`Use the calculator tool for 144 / 12. Return a compact calculator trace followed by the final answer.` matched=`False` failed_checks=`missing_required_all` completion=`A`
...
- [compliance:format] prompt=`Reply with only the number 19.` matched=`False` failed_checks=`missing_required_all` completion=`555`
...
- step=8, loss=16.8594, lr=1.25e-05
- step=16, loss=12.375, lr=2.5e-05
- step=24, loss=3.4633, lr=3.75e-05
- step=32, loss=3.325, lr=5e-05
- step=40, loss=6.5289, lr=5e-05
- step=48, loss=4.5673, lr=5e-05
- step=56, loss=2.5931, lr=5e-05
- step=64, loss=1.8855, lr=5e-05
