# Memory Transfer Session: expanded-transfer-tool-repair-nano-v1

## Command

`ava session memory-transfer expanded-transfer-tool-repair-nano-v1 sessions/2026-03-14-184859-failure-patch-v2-rerun-11m-96/checkpoints/ava-11m-failure-patch-v2.pt corpora/tool_repair_nano_v1 --device cuda --max-new-tokens 48 --nearest-threshold 0.45 --nearest-margin 0.0 --suite expanded`

## Inputs

- Checkpoint: `sessions/2026-03-14-184859-failure-patch-v2-rerun-11m-96/checkpoints/ava-11m-failure-patch-v2.pt`
- Support corpus: `corpora/tool_repair_nano_v1`
- Support files: `3`
- Support examples: `23`
...
- Exact direct: benchmark `10/20`, tool `9/12`, compliance `7/8`
- Nearest direct: benchmark `20/20`, tool `12/12`, compliance `8/8`
- Winner: `nearest`
