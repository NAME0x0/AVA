# Retrieval Session: retrieval-tool-multiview-direct-top1-v2-rerun

## Command

`ava session retrieval retrieval-tool-multiview-direct-top1-v2-rerun sessions/2026-03-14-184859-failure-patch-v2-rerun-11m-96/checkpoints/ava-11m-failure-patch-v2.pt corpora/tool_multiview_v1 --device cuda --max-new-tokens 48 --retrieval-top-k 1 --mode direct`
