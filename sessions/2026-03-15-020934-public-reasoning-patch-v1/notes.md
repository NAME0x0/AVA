# Training Session: public-reasoning-patch-v1

## Command

`ava session train public-reasoning-patch-v1 configs/experiments/ava-11m-public-reasoning-patch-v1.yaml corpora/public_reasoning_patch_v1 --max-steps 128`

## Inputs

- Config: `configs/experiments/ava-11m-public-reasoning-patch-v1.yaml`
- Corpus root: `corpora/public_reasoning_patch_v1`
...
- Optimizer steps: `64`
- Final loss: `4.3858`
- Minimum logged loss: `0.209`
- Train eval loss: `4.3983`
- Validation loss: `1.8371`
- Runtime seconds: `9.263`
- Tokens seen: `262144`
- Supervised examples kept: `102/103`
- Truncated supervised examples: `1`
- Max prompt+response tokens: `282`
- Checkpoint: `sessions\2026-03-15-020934-public-reasoning-patch-v1\checkpoints\ava-11m-public-reasoning-patch-v1.pt`
- Checkpoint sha256: `0a69b94d739572ce451ffe17ade1b1b0f512e8a9ebd9a7304ca2e298a32383a4`

## Warnings

- 1 supervised examples exceeded block_size=256 and were truncated.
...
- [benchmark:english] prompt=`Rewrite this sentence in plain English: The plan ain't done.` expected=`The plan is not finished yet.` matched=`False` completion=`The plan is not finished y`
...
- [tool:trace] prompt=`Use the calculator tool for 144 / 12. Return a compact calculator trace followed by the final answer.` matched=`True` failed_checks=`none` completion=`[calc]144 / 12=>12`
...
- step=2, loss=3.339, lr=1.25e-06
- step=4, loss=3.9387, lr=2.5e-06
- step=6, loss=0.5711, lr=3.75e-06
- step=8, loss=6.2614, lr=5e-06
- step=10, loss=1.1711, lr=5e-06
- step=12, loss=2.4845, lr=5e-06
- step=14, loss=8.6699, lr=5e-06
- step=16, loss=1.6897, lr=5e-06
