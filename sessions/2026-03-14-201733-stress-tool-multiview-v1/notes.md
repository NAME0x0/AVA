# Memory Transfer Session: stress-tool-multiview-v1

## Command

`ava session memory-transfer stress-tool-multiview-v1 D:/AVA/sessions/2026-03-14-184859-failure-patch-v2-rerun-11m-96/checkpoints/ava-11m-failure-patch-v2.pt D:/AVA/corpora/tool_multiview_v1 --device cuda --max-new-tokens 48 --nearest-threshold 0.45 --nearest-margin 0.0 --suite stress`

## Inputs

- Checkpoint: `D:/AVA/sessions/2026-03-14-184859-failure-patch-v2-rerun-11m-96/checkpoints/ava-11m-failure-patch-v2.pt`
- Support corpus: `D:/AVA/corpora/tool_multiview_v1`
- Support files: `3`
- Support examples: `97`
...
- Nearest direct: benchmark `40/40`, tool `24/31`, compliance `16/16`
- Winner: `nearest`
