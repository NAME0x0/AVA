# Memory Transfer Session: multiview-expanded-v1

## Command

`ava session memory-transfer multiview-expanded-v1 sessions/2026-03-14-184859-failure-patch-v2-rerun-11m-96/checkpoints/ava-11m-failure-patch-v2.pt corpora/tool_multiview_v1 --device cuda --max-new-tokens 48 --nearest-threshold 0.45 --nearest-margin 0.0 --suite expanded`
...
- Exact direct: benchmark `9/20`, tool `7/12`, compliance `8/8`
