# Memory Transfer Session: stress-tool-minimal-v3-rerun

## Command

`ava session memory-transfer stress-tool-minimal-v3-rerun D:/AVA/sessions/2026-03-14-184859-failure-patch-v2-rerun-11m-96/checkpoints/ava-11m-failure-patch-v2.pt D:/AVA/corpora/tool_memory_minimal_v3 --device cuda --max-new-tokens 48 --nearest-threshold 0.45 --nearest-margin 0.0 --suite stress`

## Inputs

- Checkpoint: `D:/AVA/sessions/2026-03-14-184859-failure-patch-v2-rerun-11m-96/checkpoints/ava-11m-failure-patch-v2.pt`
- Support corpus: `D:/AVA/corpora/tool_memory_minimal_v3`
- Support files: `3`
- Support examples: `21`
...
- Exact direct: benchmark `19/40`, tool `21/31`, compliance `15/16`
- Nearest direct: benchmark `40/40`, tool `31/31`, compliance `16/16`
- Winner: `nearest`
