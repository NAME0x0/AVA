# Memory Transfer Session: memory-transfer-tool-multiview-th045-v2

## Command

`ava session memory-transfer memory-transfer-tool-multiview-th045-v2 sessions/2026-03-14-184859-failure-patch-v2-rerun-11m-96/checkpoints/ava-11m-failure-patch-v2.pt corpora/tool_multiview_v1 --device cuda --max-new-tokens 48 --nearest-threshold 0.45 --nearest-margin 0.0`
...
- Exact direct: benchmark `6/10`, tool `5/6`, compliance `4/4`
- Nearest direct: benchmark `9/10`, tool `5/6`, compliance `4/4`
- Winner: `nearest`
